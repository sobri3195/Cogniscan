          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <div className="flex items-center mt-2">
                <span className={`h-3 w-3 rounded-full ${stats.serviceStatus === 'online' ? 'bg-green-500' : 'bg-red-500'} mr-2`}></span>
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Area Pemeriksaan</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Diagnosis</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tingkat Kekhawatiran</th>
                ...
                {recentInterpretations.map((interp) => (
                  <tr key={interp.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getConcernLevelColor(interp.concernLevel)}`}>
